...
const searchSpeedTest = (cb, data, sku, sortType) => {
    ...
    const log = `The search time of ${cb.name} using ${sortType}  was ${finish-start}\n`;
    logFile.write(log);
    return log;
}
...
console.log(searchSpeedTest(binarySearch, sortedData, sku, "insertion sort(.sort)"))
console.log(searchSpeedTest(binarySearch, insertionSortData, sku, "custom insertion sort"))
...
console.log(searchSpeedTest(straightSearch, bubbleSortData, sku, "bubble sort"))
console.log(searchSpeedTest(straightSearch, sortedData, sku, "insertion sort(.sort)"))
console.log(searchSpeedTest(straightSearch, insertionSortData, sku, "custom insertion sort"))
