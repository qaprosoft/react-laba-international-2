window.addEventListener('load', () => {
  ...
  darkModeButton.addEventListener('click', () => {
    ...
    if (dmIcon.classList.contains('fa-moon')) {
      ...
      logos.forEach(e =>
        e.classList.remove('portfolio-presentation__logo--dark'),
      );
      cdBtn.classList.remove('cv-contact-btn-container__cv-btn--dark');
      contactBtn.classList.remove(
        'cv-contact-btn-container__contact-btn--dark',
      );
  ...
  slider.addEventListener('click', e => {
    ...
    skillsContainer.classList.toggle(
      'skills-projects__skills-container--hidden',
    );
